...
void ImGui::ComboV(const char* label, int* current_item, std::vector<std::string>& items)
{
    auto current = items[*current_item];
    if (ImGui::BeginCombo(label, current.c_str())) // The second parameter is the label previewed before opening the combo.
    {
